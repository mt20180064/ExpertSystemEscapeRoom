...
public interface RoomRepository extends JpaRepository<Room, Long>{
	...
	@Query("SELECT r FROM Room r WHERE r.numberOfRoomsOnLocation = :num_of_rooms_on_loc")
	 List<Room> findByNumberOfRoomsOnLocation(@Param("num_of_rooms_on_loc") Long numberOfRoomsOnLocation);
